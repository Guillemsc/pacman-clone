...
namespace PacMan
{
    PinkGhostAiComponent::PinkGhostAiComponent(GEngine::GEngineCoreModules* modules, const std::weak_ptr<GEngine::Entity>& entity)
    ...
    glm::i32vec2 PinkGhostAiComponent::GetHideTargetGridPosition() const
    {
        return { 0, 0 };
    }
}
