...
namespace GEngine
{
	...
	void AnchorsUiTransformExample::Init()
	{
		...
		const std::shared_ptr<Entity> entity1 = _modules->entities->AddUiEntity().lock();
		...
		const std::shared_ptr<Entity> entity2 = _modules->entities->AddUiEntity().lock();
		...
		const std::shared_ptr<Entity> entity3 = _modules->entities->AddUiEntity().lock();
		...
		// Top square
		const std::shared_ptr<Entity> entity4 = _modules->entities->AddUiEntity().lock();
		...
		// Left square
		const std::shared_ptr<Entity> entity5 = _modules->entities->AddUiEntity().lock();
		...
		// Rotated squares
		const std::shared_ptr<Entity> entity6 = _modules->entities->AddUiEntity().lock();
		...
		const std::shared_ptr<Entity> entity7 = _modules->entities->AddUiEntity().lock();
